...
keymap("n", "<leader>tf", [[<cmd>lua require("config.customize").toggleterm.float()<cr>]])
keymap("n", "<leader>tk", "<cmd>VtrKillRunner<cr>")
keymap("n", "<leader>tl", [[<cmd>lua require("config.customize").toggleterm.lazygit()<cr>]])
keymap("n", "<leader>tm", [[<cmd>lua require("config.customize").toggleterm.neomutt()<cr>]])
keymap("n", "<leader>to", "<cmd>VtrOpenRunner<cr>")
keymap("n", "<leader>tr", [[<cmd>lua require("config.customize").toggleterm.ranger()<cr>]])
