...
Customize                          = {
  plugins                          = {
    ...
    ["alpha-nvim"]                 = { enabled = false,  default = { opts = true, config = true, keys = true }},
    ...
    ["neo-tree.nvim"]              = { enabled = true,  default = { opts = false, config = true, keys = false }},
    ...
    ["vim-illuminate"]             = { enabled = false,  default = { opts = true, config = true, keys = true }},
