...
Customize                             = {
  plugins                             = {
    ...
    ["cmp-cmdline"]                   = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lsp"]                  = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lsp-document-symbol"] = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lua"]                  = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-path"]                      = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-spell"]                     = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp_luasnip"]                   = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
