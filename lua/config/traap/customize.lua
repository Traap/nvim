...
Customize                             = {
  plugins                             = {
    ...
    ["cmd-cmdline"]                   = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmd-path"]                      = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-buffer"]                    = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-calc"]                      = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lsp"]                  = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lsp-document-symbols"] = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-nvim-lua"]                  = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp-spell"]                     = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
    ["cmp_luasnp"]                    = { enabled = true,  default  = { opts = true, config  = true, keys  = true }},
