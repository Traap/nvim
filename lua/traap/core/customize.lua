...
Customize = {
  ...
  neoformat              = false,
  neo_tree_nvim          = false, -- TODO: #3 false -> true
  noice_nvim             = false, -- TODO: #1 false -> true
  nvim_colorizer_lua     = true,
  nvim_autopairs         = true,
  nvim_base16            = true,
  nvim_lualine           = true,
  nvim_notify            = false, -- TODO: #2 false -> true
  nvim_spectre           = true,
  nvim_tree              = true, -- TODO: #4 true -> false #5 false -> true
