...
-- ------------------------------------------------------------------------- }}}
-- {{{ Step 3: Automaticall reload after `:LspInstall <server>` to avoid
--             restarting neovim.
...
-- ------------------------------------------------------------------------- }}}
-- {{{ Step 4: Assign keybindings when a lanaguage server attaches. 
...
-- ------------------------------------------------------------------------- }}}
-- {{{ Step 5: Configure lua language server for neovim development
